...
bool EntityTaskRemoveTransferLog::execute() {
  if (Global::user_log)
    Global::user_log->remove_transfer_log(transfer_log);
  if (Global::system_log)
    Global::system_log->remove_transfer_log(transfer_log);
  if (Global::metadata_log)
    Global::metadata_log->remove_transfer_log(transfer_log);
  if (Global::root_log)
    Global::root_log->remove_transfer_log(transfer_log);
